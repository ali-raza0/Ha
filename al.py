...
try:
    prox= requests.get('https://raw.githubusercontent.com/ramzantanha/RamXan/main/user.txt').text
...
\x1b[1;90m██▄▄▄▄███▄▄▄▄███▄▄▄▄██
\x1b[0m╔══o00════════00o════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m Ridho XD     \033[1;31;1m   █      
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :  \033[1;92m +628385880430 \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  : \033[1;92m  +628385880430  \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mGorup Fb  :  \033[1;92m gk punya gw \033[1;31;1m        █
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            if ww in ("Y","y","ya"):
                ubahP.append("y")
                print(f" {N}[{H}•{N}] Password example : {H}ANJENG{N}")
...
# PROSES CRACK METODE 3 in 1
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["[\x1b[1;91m■\x1b[0m□□□□□□□□□]","[\x1b[1;92m■■\x1b[0m□□□□□□□□]", "[\x1b[1;93m■■■\x1b[0m□□□□□□□]", "[\x1b[1;94m■■■■\x1b[0m□□□□□□]", "[\x1b[1;95m■■■■■\x1b[0m□□□□□]", "[\x1b[1;96m■■■■■■\x1b[0m□□□□]", "[\x1b[1;97m■■■■■■■\x1b[0m□□□]", "[\x1b[1;98m■■■■■■■■\x1b[0m□□]", "[\x1b[1;99m■■■■■■■■■\x1b[0m□]", "[\x1b[1;910m■■■■■■■■■■\x1b[0m]"])
    ...
    def kombinasi_pw(self,url):
        ...
        print('%s[%s1%s] Password v1'%(H,H,H))
        print('%s[%s2%s] Password v2'%(H,H,H))
...
def alok():
    try:
        ...
        os.system("clear")
        logo()
        print(' [%s!%s] Hubungi Admin jika ada yang memperjual\n belikan SC Meta. SC ini %sGRATIS BANGSAT%s'%(M,N,H,N))
        ...
        if pil =="":
            ...
            os.system('xdg-open https://wa.me/628385880430?text=Hallo+izin+menggunakan+SC+ini');time.sleep(2);alok()
        elif pil in["1","01"]:
            print('%s══════════════════════════════════════════'%(N))
